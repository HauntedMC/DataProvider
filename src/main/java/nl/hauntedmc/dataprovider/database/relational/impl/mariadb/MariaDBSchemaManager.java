...
/**
 * MariaDB implementation of SchemaManager.
 * (Nearly identical to the MySQL implementation.)
 */
public class MariaDBSchemaManager implements SchemaManager {

    private final HikariDataSource dataSource;
    private final ExecutorService executor;

    public MariaDBSchemaManager(HikariDataSource dataSource, ExecutorService executor) {
